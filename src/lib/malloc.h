...
#include "../lib/stdio.h"    /* needed for malloc_stats */
...
#if __STD_C
Void_t*  sYSMALLOc(INTERNAL_SIZE_T, mstate);
int      sYSTRIm(size_t, mstate);
void     malloc_consolidate(mstate);
Void_t** iALLOc(size_t, size_t*, int, Void_t**);
#else
Void_t*  sYSMALLOc();
int      sYSTRIm();
