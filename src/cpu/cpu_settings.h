...
#define USER_CS    0x28
#define USER_DS    0x30
#define USER_CS_16 0x38
#define USER_DS_16 0x40

#define USER_CODE_SEGMENT_BASE  0x20000000
#define USER_CODE_SEGMENT_LIMIT 0x000FFFFF
#define USER_DATA_SEGMENT_BASE  0x02000000
#define USER_DATA_SEGMENT_LIMIT 0x000FFFFF

#define USER_CODE_SEGMENT_BASE_16  0x02000000
#define USER_CODE_SEGMENT_LIMIT_16 0x000FFFFF
